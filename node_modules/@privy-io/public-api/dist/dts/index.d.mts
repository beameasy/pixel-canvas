...
declare const EmbeddedWalletConfigSchema: z$1.ZodObject<{
    /**
     ...
     */
    create_on_login: z$1.ZodEnum<["users-without-wallets", "all-users", "off"]>;
    /**
     ...
     */
    user_owned_recovery_options: z$1.ZodArray<z$1.ZodEnum<["user-passcode", "google-drive", "icloud"]>, "many">;
    /**
     ...
     * Overridable from client.
     */
    require_user_owned_recovery_on_create: z$1.ZodOptional<z$1.ZodBoolean>;
    /**
     ...
     * Overridable from client.
     */
    require_user_password_on_create: z$1.ZodOptional<z$1.ZodBoolean>;
...
type EmbeddedWalletConfig = Prettify<z$1.infer<typeof EmbeddedWalletConfigSchema>>;
declare const TelegramAuthConfigSchema: z$1.ZodObject<{
    bot_id: z$1.ZodString;
    bot_name: z$1.ZodString;
    link_enabled: z$1.ZodBoolean;
    seamless_auth_enabled: z$1.ZodBoolean;
}, "strip", z$1.ZodTypeAny, {
    bot_id: string;
    bot_name: string;
    link_enabled: boolean;
...
declare const FundingMethodEnum: z$1.ZodEnum<["moonpay", "coinbase-onramp", "external"]>;
declare const FundingMethodArraySchema: z$1.ZodArray<z$1.ZodEnum<["moonpay", "coinbase-onramp", "external"]>, "many">;
type FundingMethod = z$1.infer<typeof FundingMethodEnum>;
declare const FundingConfigResponseSchema: z$1.ZodObject<{
    default_recommended_currency: z$1.ZodObject<{
        chain: z$1.ZodString;
    ...
    default_recommended_amount: z$1.ZodString;
    methods: z$1.ZodArray<z$1.ZodEnum<["moonpay", "coinbase-onramp", "external"]>, "many">;
    ...
    prompt_funding_on_wallet_creation: z$1.ZodBoolean;
    cross_chain_bridging_enabled: z$1.ZodBoolean;
}, "strip", z$1.ZodTypeAny, {
    options: {
        method: string;
        provider: string;
...
type FundingConfig = Prettify<z$1.infer<typeof FundingConfigResponseSchema>>;
...
declare const Condition: z.ZodObject<{
    /** The field's source (e.g. ethereum_transaction) */
    field_source: z.ZodEnum<["ethereum_transaction", "ethereum_calldata"]>;
    /** The field to compare in the condition */
    field: z.ZodUnion<[z.ZodLiteral<"to">, z.ZodLiteral<"value">, z.ZodString]>;
    /** The operator to use */
    ...
    abi: z.ZodOptional<z.ZodType<Json, z.ZodTypeDef, Json>>;
}, "strict", z.ZodTypeAny, {
    value: string | string[];
...
declare const ForkedToken: z.ZodObject<{
    token: z.ZodString;
    refresh_token: z.ZodString;
...
interface PrivyForkedToken extends z.infer<typeof ForkedToken> {
}
