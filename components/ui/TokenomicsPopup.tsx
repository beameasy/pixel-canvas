...
export default function TokenomicsPopup({ isOpen, onClose }: TokenomicsPopupProps) {
  ...
  return (
    ...
    >
      <div 
        className="bg-slate-800 border border-slate-700 rounded-lg max-w-[95vw] sm:max-w-md md:max-w-lg lg:max-w-xl w-full max-h-[80vh] sm:max-h-[75vh] overflow-y-auto mt-4"
      ...
      >
        ...
        <div className="p-3 sm:p-4 space-y-2 sm:space-y-3 text-slate-300 font-mono text-xs">
          <p className="mb-1">
            Holding $BILLBOARD tokens provides benefits for pixel placement:
          </p>
          
          <div className="bg-slate-800/50 p-2 border border-slate-700 rounded-md mb-2">
            <p className="text-emerald-300 mb-1">Protection System:</p>
            <p>
          ...
          <h2 className="text-[#FFD700] text-sm font-mono mb-1 pt-1">$BILLBOARD Token Tiers</h2>
