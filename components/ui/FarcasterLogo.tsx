interface FarcasterLogoProps {
  className?: string;
  size?: 'sm' | 'md' | 'lg';
}

export default function FarcasterLogo({ className = '', size = 'md' }: FarcasterLogoProps) {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-5 h-5',
    lg: 'w-6 h-6'
  ...
  return (
    ...
    >
      <rect width="1000" height="1000" rx="200" fill="transparent"/>
